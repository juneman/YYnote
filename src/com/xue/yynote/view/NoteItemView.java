...
public class NoteItemView extends LinearLayout {
	...
	public void setModel(NoteItemModel itemModel) {
		...
		this.setClockTv();
		this.mModifyTime.setText(this.getFormatModifyTime(itemModel
				.getModifyDate()));
									...
									public void onClick(DialogInterface dialog,
										...
										DBHelper dbHelper = DBHelper
												.getInstance(NoteItemView.this
														.getContext());
										dbHelper.delete(
												DBHelper.TABLE.ALERTS,
												ClockModel.ID
														+ " = "
														+ NoteItemView.this.mItemModel
																.getClockId(),
												null);
										dbHelper.delete(
												...
												NoteItemModel.ID
														...
														+ NoteItemView.this.mItemModel
																.getId(), null);
										NotesListView mListView = (NotesListView) NoteItemView.this
												.getParent();
										mListView
												.setStatus(NotesListView.STATUS_DELETE);
										mListView
	...
	public void updateSequence(DBHelper dbHelper) {
		...
		dbHelper.update(DBHelper.TABLE.NOTES, cv, NoteItemModel.ID + " = "
				+ NoteItemView.this.mItemModel.getId(), null);
	}
